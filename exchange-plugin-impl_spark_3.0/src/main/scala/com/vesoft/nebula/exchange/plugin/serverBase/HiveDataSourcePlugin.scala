...
import com.vesoft.exchange.common.config.{DataSourceConfigEntry, HiveSourceConfigEntry}
import com.vesoft.nebula.exchange.plugin.DataSourcePlugin
import org.apache.spark.sql.{DataFrame, SparkSession}

/**
* ClassName: HiveDataSourcePlugin
* Package: com.vesoft.nebula.exchange.plugin.serverBase
* Description:
 *
 * @author lx
* @version 1.0   
*/
class HiveDataSourcePlugin extends DataSourcePlugin{
   ...
   * @return 数据源插件类型字符串
   */
  override def category: String = "hive"
