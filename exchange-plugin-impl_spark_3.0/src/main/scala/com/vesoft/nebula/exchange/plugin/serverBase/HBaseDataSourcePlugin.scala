...
import com.vesoft.exchange.common.config.{DataSourceConfigEntry, HBaseSourceConfigEntry}
import com.vesoft.nebula.exchange.plugin.DataSourcePlugin
import org.apache.spark.sql.{DataFrame, SparkSession}

/**
* ClassName: HBaseDataSourcePlugin
* Package: com.vesoft.nebula.exchange.plugin.serverBase
* Description:
 *
 * @author lx
...
class HBaseDataSourcePlugin extends DataSourcePlugin{
   ...
   * @return 数据源插件类型字符串
   */
  override def category: String = "hbase"
